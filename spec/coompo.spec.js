...
describe("[Coompo.js]", () =>
{
    ...
    describe("[Props]", () =>
    {
        describe("should handle props' default values well", () =>
        {
            ...
            it("in case of initialized value", () =>
            {
                ...
                expect(title.of({ text: 'Hello world'})).toBe('<h1 _coo-i="0">Hello world</h1>')
            })
            ...
            it("in case of defined non-null default value", () =>
            {
                ...
                expect(title.of()).toBe('<h1 _coo-i="0">(Untitiled)</h1>')
            })
            ...
            it("in case of defined null default value", () =>
            {
                ...
                expect(title.of()).toBe('<h1 _coo-i="0">null</h1>')
            })
            ...
            it("in case of undefined default value", () =>
            {
                ...
                expect(title.of()).toBe('<h1 _coo-i="0">undefined</h1>')
            })
    ...
    `<section _coo-i="0">
        <h1 _coo-i="1">Hello world</h1>
        <p _coo-i="2">Firstly.</p><p _coo-i="3">Secondly.</p>
    </section>`
        ...
        describe('should forbid less or more than one root HTML element', () => {
            ...
            it('in the case of one root element', () => {
                ...
                expect(text.of()).toBe('<p _coo-i="0">Hello world</p>')
            })
